...
import { 
  Tag, MapPin, Phone, Users, Calendar, 
  AlignLeft, Save, X, AlertCircle, CheckSquare, RotateCcw
} from 'lucide-react';
...
const EventosNacionais = () => {
  ...
  const validateForm = useCallback(() => {
    const newErrors = {};
    const requiredFields = ['nome', 'localizacao', 'telefone', 'numero_participantes', 'descricao', 'data_inicio', 'data_termino'];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('/eventosNacionais', formattedData);
      ...
      const errorMessage = error.response?.data?.message || "Erro ao cadastrar evento.";
    ...
    <div className="bg-white rounded-xl shadow-lg w-full">
      ...
      <div className="p-6">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Cadastrar Eventos Nacionais</h1>
...
export default EventosNacionais;