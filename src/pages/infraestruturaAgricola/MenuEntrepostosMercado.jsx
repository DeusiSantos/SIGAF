...
import GestaoEntrepostosMercado from '../EntrepostasMercado/GestaoEntrepostosMercado';
import CadastroEmpresas from '../SociedadeAgricola/CadastroEmpresas';
import CadastroEntrepostosMercado from '../EntrepostasMercado/CadastroEntrepostosMercado';
...
const MenuEntrepostosMercado = () => {
    ...
    const menuItems = [
         {
            id: 'gestao',
            title: 'Gestão Entrepostos Agrícola',
            icon: Users,
            description: 'Gerenciar Entrepostos Agrícola',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar Entrepostos Agrícola',
            icon: UserPlus,
            description: 'Novo Entreposto e Mercado Agrícola',
            color: 'blue'
        },
    ];
