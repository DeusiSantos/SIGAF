...
import GestaoApoiFlorestal from './GestaoApoioFlorestal';
import RegistroApoioFlorestal from './RegistroApoioFlorestal';
...
const MenuApoioAgricola = () => {
    ...
    const { produtor } = useProdutores();
    const { produtor: produtoresAprovados } = useProdutoresAprovados();

    // Atualizar produtores locais quando os dados da API mudarem
    useEffect(() => {
        let todos = [];
        if (produtor && Array.isArray(produtor)) todos = todos.concat(produtor);
        if (produtoresAprovados && Array.isArray(produtoresAprovados)) todos = todos.concat(produtoresAprovados);
        setLocalProdutores(todos);
    }, [produtor, produtoresAprovados]);

    useEffect(() => {
      console.log('localProdutores:', localProdutores);
      console.log('produtor (useProdutores):', produtor);
      console.log('produtoresAprovados (useProdutoresAprovados):', produtoresAprovados);
    }, [localProdutores, produtor, produtoresAprovados]);

    const menuItems = [
        {
            id: 'gestao',
            title: 'Gestão Apoio Florestal',
            icon: Users,
            description: 'Visualizar Apoio Florestal',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Registrar Apoio Florestal',
            icon: UserPlus,
            description: 'Registrar novo Apoio Florestal',
            color: 'blue'
        }
    ];
                        ...
                        {activeSection === 'cadastro' ? (
                            <div className="w-full ">
                                <div className="grid grid-cols-1  md:grid-cols-2 gap-8 items-start mb-6">
                                    <div className="text-center md:text-left ">
                                        ...
                                        <p className="text-gray-700 text-base leading-relaxed">
                                            O Registo Nacional de Produtores Florestais visa criar uma base de dados abrangente dos produtores florestais em Angola, facilitando o planejamento de políticas públicas e a distribuição eficiente de recursos.
                                        </p>
                                    </div>
                                    <div>
                                        <h3 className="font-bold text-lg mb-2">Benefícios:</h3>
                                        <ul className="space-y-2">
                                            <li className="flex items-center text-gray-700"><span className="text-green-600 mr-2"><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'><path strokeLinecap='round' strokeLinejoin='round' d='M5 13l4 4L19 7'/></svg></span> Acesso a programas de assistência técnica florestal</li>
                                            <li className="flex items-center text-gray-700"><span className="text-green-600 mr-2"><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'><path strokeLinecap='round' strokeLinejoin='round' d='M5 13l4 4L19 7'/></svg></span> Facilitação de crédito florestal</li>
                                            <li className="flex items-center text-gray-700"><span className="text-green-600 mr-2"><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'><path strokeLinecap='round' strokeLinejoin='round' d='M5 13l4 4L19 7'/></svg></span> Participação em projetos de desenvolvimento florestal</li>
                                            <li className="flex items-center text-gray-700"><span className="text-green-600 mr-2"><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth='2'><path strokeLinecap='round' strokeLinejoin='round' d='M5 13l4 4L19 7'/></svg></span> Recebimento de insumos e equipamentos florestais</li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mt-4">
                                    ...
                                    <span className="text-blue-700">Todas as informações fornecidas são confidenciais e serão utilizadas exclusivamente para fins de políticas públicas florestais, conforme a <a href='https://www.angola.gov.ao/ao/lei-protecao-dados-pessoais' target='_blank' rel='noopener noreferrer' className='underline font-semibold'>Lei de Proteção de Dados Pessoais de Angola</a>.</span>
                                </div>
                            </div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <ul className="space-y-1 text-base text-gray-600">
                                        <li>• Silvicultura</li>
                                        <li>• Exploração Florestal</li>
                                        <li>• Reflorestamento</li>
                                        <li>• Produtos Florestais Não Madeireiros</li>
                                        <li>• Conservação Florestal</li>
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-1 text-base text-gray-600">
                                        <li>• Acesso a programas governamentais florestais</li>
                                        <li>• Facilitação de crédito florestal</li>
                                        <li>• Assistência técnica florestal</li>
