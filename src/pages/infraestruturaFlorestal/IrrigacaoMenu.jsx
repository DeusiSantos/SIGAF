...
import CadastroFontesAgua from './CadastroFontesAgua';
import GestaoSistemasIrrigacao from './GestaoSistemasIrrigacao';
...
const IrrigacaoMenu = () => {
    ...
    const menuItems = [
         {
            id: 'gestao',
            title: 'Gestão Irrigação Florestal',
            icon: Users,
            description: 'Gerenciar Irrigação Florestal',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar Irrigação Florestal',
            icon: UserPlus,
            description: 'Nova Irrigação Florestal',
            color: 'blue'
        },
    ];
