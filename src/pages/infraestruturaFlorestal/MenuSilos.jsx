...
import GestaoSilos from './GestaoSilos';
import CadastroEmpresas from '../SociedadeAgricola/CadastroEmpresas';
import CadastroSilos from './CadastroSilos';
...
const MenuSilos = () => {
    ...
    const menuItems = [
         {
            id: 'gestao',
            title: 'Gestão Silos Florestal',
            icon: Users,
            description: 'Gerenciar Silos Florestal',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar Silos Florestal',
            icon: UserPlus,
            description: 'Novo Silos Florestal',
            color: 'blue'
        },
    ];
