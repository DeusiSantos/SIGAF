...
const ProdutoresGestao = () => {
    ...
    const { produtor, loading: loadingProdutor } = useProdutoresAprovados();
    ...
    // Função para deletar produtor após confirmação
    ...
    return (
        <div className="min-h-screen" ref={containerRef}>
            ...
            <div className="w-full bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-6 text-white">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
                        <div>
                            <h1 className="text-2xl font-bold">RNPA - Gestão de Produtores</h1>
            ...
            {/* Botão de informações do RNPA */}
            <div className="mt-6 flex justify-center">
                <button
                    onClick={() => setShowInfoModal(true)}
                    className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors shadow-sm"
                    title="Informações sobre o RNPA"
                >
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center text-blue-700">
                                ...
                                <h2 className="text-xl font-semibold">Registo Nacional de Produtores Agrícolas</h2>
                            </div>
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                <h3 className="text-sm font-medium text-gray-800 mb-2">Actividades Registadas:</h3>
                            ...
                            <div>
                                <h3 className="text-sm font-medium text-gray-800 mb-2">Estado dos Processos:</h3>
                                <ul className="space-y-1 text-sm text-gray-600">
