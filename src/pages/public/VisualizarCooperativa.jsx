...
const VisualizarCooperativa = () => {
    ...
    const { updateCooperativa } = useCooperativas();
    ...
    const handleUpdateEstado = async (novoEstado) => {
        try {
            ...
            formData.append('id', cooperativa.id);
            formData.append('estado', novoEstado);

            await api.patch(`/cooperativa/estado`, formData, {
                headers: {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg shadow p-6 border">
                            ...
                            {(cooperativa.atividades && cooperativa.atividades.length > 0) && (
