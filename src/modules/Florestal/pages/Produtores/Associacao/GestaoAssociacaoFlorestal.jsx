...
const GestaoAssociacaoFlorestal = () => {
    ...
    const fetchEmpresas = async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await api.get('/organizacao/AssociacoesFlorestais');
            ...
            <div className="w-full bg-white rounded-xl shadow-md overflow-visible z-10">
                ...
                <div className="bg-gradient-to-r from-blue-700 to-blue-500 p-6 text-white">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
                        <div>
                            <h1 className="text-2xl font-bold">Gestão de Associacões Florestais</h1>
                        </div>
...
export default GestaoAssociacaoFlorestal;