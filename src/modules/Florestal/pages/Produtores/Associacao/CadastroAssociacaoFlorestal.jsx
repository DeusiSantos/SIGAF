...
const CadastroAssociacaoFlorestal = () => {
  ...
  const initialState = {
    TipoDeEntidade: "AssociacaoFlorestal",
    // Dados da Empresa
    NomeEntidade: '',
    Sigla: '',
    NIF: '',
      ...
      <div className="mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
          ...
          <div className="text-center mb-8 p-8 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-emerald-50">
            <h1 className="text-4xl font-bold mb-3 text-gray-800">Cadastro de Associações Florestais</h1>
          </div>
...
export default CadastroAssociacaoFlorestal;