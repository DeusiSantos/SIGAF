            ...
            case 2: // Tipo de Produção
                return (
                    <div className="max-w-full mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div
                                className={`p-6 border-2 rounded-2xl transition-all ${isEditing ? 'cursor-pointer hover:shadow-md' : ''} ${formData.tipoProducao === 'agricola' || formData.tipoProducao === 'agrícola'
                            ...
                            <div
                                className={`p-6 border-2 rounded-2xl transition-all ${isEditing ? 'cursor-pointer hover:shadow-md' : ''} ${formData.tipoProducao === 'pecuaria' || formData.tipoProducao === 'pecuária'
                                    ? 'border-blue-500 bg-blue-50'
                                    : 'border-gray-200'
                                    }`}
                            ...
                            <div
                                className={`p-6 border-2 rounded-2xl transition-all ${isEditing ? 'cursor-pointer hover:shadow-md' : ''} ${formData.tipoProducao === 'ambas'
                                    ? 'border-blue-500 bg-blue-50'
                                    : 'border-gray-200'
                                    }`}
                                ...
                                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className={`flex flex-col items-center justify-center h-40 sm:h-48 md:h-56 px-4 py-6 border-2 border-dashed rounded-xl cursor-pointer transition-all duration-200 ${previewPerfil || formData.fotoPraga ?
                                ...
                                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className={`flex flex-col items-center justify-center h-40 sm:h-48 md:h-56 px-4 py-6 border-2 border-dashed rounded-xl cursor-pointer transition-all duration-200 ${previewDigitais || formData.fotoPragaPecuaria ?
                                                'bg-green-50 border-green-300 hover:bg-green-100' :
                                                'bg-gray-50 border-gray-300 hover:border-blue-400 hover:bg-blue-50'
                                                }`}
                                        >
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                    <div className="p-6">
                        ...
                        <div className="mt-4 flex items-center gap-4">
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${currentStatus === 'Controlado' ? 'bg-green-100 text-green-800 border-green-300' :
