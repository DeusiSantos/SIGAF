...
const CadastroAssociacaoAgricola = () => {
  ...
  const initialState = {
    TipoDeEntidade: "AssociacaoAgricola",
    // Dados da Empresa
    NomeEntidade: '',
    Sigla: '',
    NIF: '',
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="mx-auto px-4 py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 rounded-t-2xl" >
          {/* Header */}
          <div className="text-center mb-8 p-8 border-b border-gray-100 bg-gradient-to-r from-blue-700 to-blue-500 rounded-t-2xl">
            <h1 className="text-4xl font-bold mb-3 text-white">Cadastro de Associações </h1>
          </div>
...
export default CadastroAssociacaoAgricola;