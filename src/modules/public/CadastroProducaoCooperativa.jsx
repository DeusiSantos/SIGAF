...
const cooperativasExistentes = [
    ...
    },
    {
        id: 2,
        tipo: "COOPERATIVA",
        nome: "Cooperativa de Produtores de Café do Uíge",
        codigo: "CPCU002",
        nif: "2345678901",
    ...
    },
    {
        id: 3,
        tipo: "COOPERATIVA",
        nome: "Cooperativa Agropecuária Unidos do Campo",
        codigo: "CAUC003",
        nif: "3456789012",
    ...
    },
    {
        id: 4,
        tipo: "COOPERATIVA",
        nome: "Cooperativa de Apicultores do Planalto",
        codigo: "CAP004",
        nif: "4567890123",
    ...
    },
    {
        id: 5,
        tipo: "COOPERATIVA",
        nome: "Cooperativa Hortícola da Huíla",
        codigo: "CHH005",
        nif: "5678901234",
    ...
    },
    {
        id: 6,
        tipo: "COOPERATIVA",
        nome: "Cooperativa de Piscicultores do Kwanza",
        codigo: "CPK006",
        nif: "6789012345",
...
const CadastroProducaoCooperativa = () => {
                    ...
                    <div className="w-full mx-auto">
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-8 border border-blue-100">
                            ...
                            <p className="text-gray-600">
                                Informações básicas da entidade associativa.
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <CustomInput
                                    ...
                                    options={[
                                        { label: 'Cooperativa', value: 'ASSOCIACAO' },
                                ...
                                <CustomInput
                                    type="text"
                                    label="Código do Produtor Nacional"
                    ...
                    <div className="w-full mx-auto">
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-8 border border-blue-100">
                            <div className="flex items-center space-x-3 mb-3">
                                ...
                                <h3 className="text-xl font-bold text-gray-800">Vistorias e Acompanhamento Técnico</h3>
                            </div>
                            <p className="text-gray-600">
                                Registre as vistorias técnicas realizadas na cooperativa.
                            </p>
                        </div>
                    ...
                    <div className="w-full mx-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-2xl border border-gray-200 p-6">
                                ...
                                <p className="text-gray-600 mb-4">Selecione para que fins o certificado será utilizado:</p>
                                <CustomInput
                                    type="multiselect"
            ...
            <div className="">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
                    ...
                    <div className="text-center mb-6 p-8 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-blue-50">
                        ...
                        <p className="text-xl text-gray-700 mb-2">Certificação de Cooperativa</p>
                    </div>
                ...
                <div className="mt-8 bg-white p-8 shadow-sm rounded-2xl border border-gray-200">
                    <div className="flex items-center text-blue-700 mb-4">
                        ...
                        <h3 className="text-xl font-semibold">Sobre a Certificação de Cooperativas</h3>
                    </div>
...
export default CadastroProducaoCooperativa;