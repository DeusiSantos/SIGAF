...
import CadastroAgentesCampo from '../../pages/AgenteDeCampo/CadastroAgentesCampo';
import AgenteCampo from '../../pages/AgenteDeCampo/AgenteCampo';

const GestaoInqueridorMenu = () => {
    const [activeSection, setActiveSection] = useState('gestao');

    const menuItems = [
         {
            id: 'gestao',
            title: 'Gestão de Agente de Campo',
            icon: Users,
            description: 'Visualizar e gerenciar Agentes de Campo cadastrados',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar Agente de Campo',
            icon: UserPlus,
            description: 'Registrar novo Agente de Campo no sistema',
            color: 'blue'
        },
    ];
...
export default GestaoInqueridorMenu;