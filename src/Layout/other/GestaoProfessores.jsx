...
import ProfessoresGestao from '../../pages/ProfessoresGestao';

const GestaoProfessoresMenu = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: Users,
            description: 'Visualizar e gerenciar professores cadastrados',
            color: 'green'
        }
    ];
...
export default GestaoProfessoresMenu;