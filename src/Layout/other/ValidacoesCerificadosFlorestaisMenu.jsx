    ...
    const menuItems = [
         {
            ...
            icon: Users,
            description: 'Visualizar e gerenciar os Certificados Emitidos',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar Certificação',
            icon: UserPlus,
            description: 'Registrar nova Certificação no sistema',
            color: 'blue'
        },
    ];
...
export default ValidacoesCerificadosFlorestaisMenu;