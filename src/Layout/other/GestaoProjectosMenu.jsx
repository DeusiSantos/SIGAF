    ...
    const menuItems = [
         {
            ...
            icon: Users,
            description: 'Visualizar e gerenciar Projectos e Benefícios cadastradas',
            color: 'green'
        },
        {
            id: 'cadastro',
            title: 'Cadastrar de Projectos e Programas',
            icon: UserPlus,
            description: 'Registrar novo Projectos e Benefícios no sistema',
            color: 'blue'
        },
    ];
