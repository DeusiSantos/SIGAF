...
import GestaoEscolas from '../../pages/GestaoEscola';

const GestaoEscolaMenu = () => {
    ...
    const menuItems = [
        {
            ...
            icon: UserPlus,
            description: 'Registrar nova escola no sistema',
            color: 'blue'
        },
        {
            id: 'gestao',
            ...
            icon: Users,
            description: 'Visualizar e gerenciar escolas cadastradas',
            color: 'green'
        }
    ];
...
export default GestaoEscolaMenu;